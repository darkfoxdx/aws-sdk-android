...
class RegionDefaults {
    public static List<Region> getRegions() {
        ...
        updateRegion(region, "cognito-identity", "cognito-identity.eu-north-1.amazonaws.com",
                false, true);
        updateRegion(region, "cognito-idp", "cognito-idp.eu-north-1.amazonaws.com", false, true);
        updateRegion(region, "cognito-sync", "cognito-sync.eu-north-1.amazonaws.com", false, true);
        updateRegion(region, "data.iot", "data.iot.eu-north-1.amazonaws.com", false, true);
        ...
        updateRegion(region, "polly", "polly.eu-north-1.amazonaws.com", false, true);
