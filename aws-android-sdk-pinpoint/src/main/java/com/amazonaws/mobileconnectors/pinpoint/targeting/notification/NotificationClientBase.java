...
abstract class NotificationClientBase {
    ...
    private boolean openApp(final Bundle data) {
        ...
        launchIntent.putExtra(NotificationClient.INTENT_BUNDLE, data);
        launchIntent.setPackage(null);
        pinpointContext.getApplicationContext().startActivity(launchIntent);
        return true;
    }

    private void openURL(final Bundle data, final String url, final boolean noSchemeValidation) {
        ...
        intent.putExtra(NotificationClient.INTENT_BUNDLE, data);
